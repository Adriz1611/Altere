...
export default function Navbar() {
    ...
    return (
        <header className="py-6">
            <center>
                <nav className="border w-1/2 rounded-[2rem] flex flex-row items-center justify-between px-3">
                    <Image src="/nav-log.png" alt="logo" height={150} width={150} className=" p-3"/>
